 ...
 */
public class TestWithHadoopFiles {
...
//        String outputPath = "data/productfeatureout";
//        String inputPath = "data/dir1,data/dir2";
        ...
        if (args[3].equals("local")) {
            getLocalPaths(inputPath);
        } else {
            getHadoopPaths(inputPath);
        }
...
//        }
    ...
    public static void getLocalPaths(String inputPath) {
    ...
    public static void getHadoopPaths(String inputPath) {
        String[] dirPaths = inputPath.split(",");
        for (String dirPath : dirPaths) {
            try {
